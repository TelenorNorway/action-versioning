...
async function commit(increment, token, repository) {
    ...
    (0, console_1.debug)("Max version is v" + max);
    (0, core_1.setOutput)("deploy", "yes");
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    const newVersion = ((_b = (_a = (0, semver_1.parse)(max)) === null || _a === void 0 ? void 0 : _a.inc) === null || _b === void 0 ? void 0 : _b.call(_a, increment)) || undefined;
    if (!newVersion) {
        throw new Error("Could not increment version!");
    }
    console.log("new version = v%s", newVersion);
    (0, core_1.setOutput)("version", "v" + newVersion);
    (0, core_1.notice)("New version is v" + newVersion);
}
